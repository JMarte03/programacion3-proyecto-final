            ...
            <table class="w-full whitespace-no-wrap">
              ...
              <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                  ...
                  <td class="px-4 py-3"> <?= $row['team_id'] ?> </td>
                  <td class="px-4 py-3 text-sm"> <?= $row['team_title'] ?> </td>
                  <td class="px-4 py-3 text-sm"> <?= $row['leader'] ?> </td>
                  <td class="px-4 py-3 text-sm"> <?= $row['team_description'] ?> </td>

                  <td class="px-4 py-3">
                    <div class="flex items-center space-x- text-sm">
                      <a href="update_team.php?team_id=<?= $row['team_id'] ?>">
                        <button
